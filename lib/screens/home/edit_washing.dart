...
class EditWashing extends StatefulWidget {
  const EditWashing({
    Key? key,
    required this.doc,
    required this.name,
  ...
  @override
  EditWashingState createState() => EditWashingState();
  /*State<StatefulWidget> createState() {
    return EditWashingState();
  }*/
}

class EditWashingState extends State<EditWashing> {
                  ...
                  child: Column(
                    children: [
                      ...
                      MaterialButton(
                        ...
                        onPressed: () async {
                          if (!taken) {
                            if (program == "בחר תוכנית") {
                              showSimpleDialog(
                                  context, "שגיאה", "עליך לבחור תוכנית");
                            } else {
                              date = new DateTime(now.year, now.month, now.day,
                                  now.hour, now.minute + _progLength!);
